...
//
  $('.offer__slider').slick({
    prevArrow: '<button type="button" class="slick-prev"><img src="img/angle-left-solid.svg" class="projects__left"></button>',
    nextArrow: '<button type="button" class="slick-next"><img src="img/angle-right-solid.svg" class="projects__right"></button>',
    infinite: true,
    slidesToShow: 1,
    slidesToScroll: 1,
    autoplay: true,
